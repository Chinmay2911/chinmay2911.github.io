...
function Contact() {
  ...
  return (
    <main className="container mx-auto max-width section">
      ...
      <span className="text-center text-content text-1xl font-light block">Don't forget to</span>
      <h3 className="text-center text-2xl md:text-4xl lg:text-4xl text-gradient">
