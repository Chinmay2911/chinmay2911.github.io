...
function Home() {
  ...
  return (
    <main className="container mx-auto max-width section md:flex justify-between items-center text-align: -webkit-center;">
      {/* <Particles/> */}
      <div>
        <h1
          ref={h11}
        ...
        <h2
          ref={h13}
          className="text-2xl text-dark-heading  md:text-4xl xl:text-4xl xl:leading-tight font-bold"
        >
          {tagline}
        </h2>
